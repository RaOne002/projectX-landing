...
const fourThings = [
  ...
  { num: "03", text: "Cold start in seconds.", image: "/images/home_four-things/3.png" },
...
const buildingData = [
  ...
  { title: "Education & Academia", image: "/images/home_building/education.png" },
  { title: "AI/ML Development", image: "/images/home_building/ai-ml.png" },
    ...
    <div className="relative min-h-screen bg-background overflow-x-clip mx-1 md:mx-0">
      ...
      <section ref={mockupSectionRef} className="relative z-10 mt-8 md:mt-12 px-4 md:px-8 xl:px-0 w-full">
        ...
        <div className="xl:hidden max-w-[1000px] w-full mx-auto">
          <div className="relative w-full rounded-[12px] md:rounded-[18px] overflow-hidden shadow-[0_0_30px_rgba(0,0,0,0.4)] border border-white/5" style={{ aspectRatio: "837/514" }}>
            <Image src="/images/homepage-frame-1.png" alt="Infinity OS — one session, multiple apps" fill sizes="(max-width: 1280px) 100vw, 1100px" className="object-cover" priority />
          </div>
        </div>
      </section>
      ...
      <section className="relative z-10 mt-16 px-4 md:px-1 max-w-[960px] mx-auto flex flex-col gap-4">
        <div className="flex items-end gap-0">
          <div className="relative bg-neutral-900 rounded-[18px] rounded-bl-[4px] p-4 sm:px-[12px] sm:py-[6px] max-w-[476px]">
            ...
            <svg className="absolute -bottom-[6px] -left-[8px]" width="16" height="12" viewBox="0 0 16 12" fill="none"><path d="M16 0 Q16 12 0 12 Q6 12 8 6 Z" fill="#262827" /></svg>
          </div>
        </div>
        <div className="flex justify-end items-end gap-0">
          <div className="relative bg-[#00a87e] rounded-[12px] rounded-br-[4px] px-[14px] py-[8px]">
            ...
            <svg className="absolute -bottom-[6px] -right-[8px]" width="16" height="12" viewBox="0 0 16 12" fill="none"><path d="M0 0 Q0 12 16 12 Q10 12 8 6 Z" fill="#00a87e" /></svg>
          </div>
        </div>
      </section>
      ...
      <section className="relative z-10 mt-24 px-4 sm:px-1 max-w-[1300px] mx-auto">
        <div className="flex flex-col xl:flex-row items-center text-center xl:text-left gap-12 xl:gap-[133px]">
          ...
          <div className="flex flex-col items-center xl:items-start gap-6 w-full max-w-[494px] shrink-0">
            ...
            <Button href="/for-agents" size="md">Learn More</Button>
          </div>
          {/* Right card */}
      ...
      <section className="relative z-10 mt-12 w-full max-w-[1300px] mx-auto">
        ...
        <div className="flex md:hidden w-full overflow-hidden pb-8 mt-4">
          ...
          >
            {steps.map((step, i) => (
              <SwiperSlide key={`${step.label}-${i}`} className="!w-[85vw] !max-w-[350px] h-auto">
                <div className="flex flex-col gap-[19px]">
                  <div className="bg-[rgba(34,34,34,0.6)] rounded-[8px] overflow-hidden">
                    ...
                    <div className="relative w-full" style={{ aspectRatio: "357/208" }}>
                      <Image src={step.image} alt={step.label} fill sizes="(max-width: 768px) 85vw, 350px" className="object-cover rounded-b-[8px]" />
                    </div>
                  </div>
        ...
        <div className="flex flex-col lg:flex-row lg:gap-12 xl:gap-20 items-center lg:items-start justify-center w-full">
          ...
          <div className="flex flex-col w-full flex-1 max-w-[600px] lg:max-w-none mb-16 lg:mb-0">
            ...
            <div className="mt-9 bg-neutral-800 rounded-[8px] overflow-hidden">
              ...
              <div className="relative w-full aspect-[400/280] overflow-hidden rounded-b-[8px]">
                <Image src="/images/home_paradigm-shift/old-way-macbook.png" alt="Every other computer mockup" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover rounded-b-[10px]" />
              </div>
            </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 lg:gap-4 xl:gap-8 items-start sm:items-center">
                ...
                <div className="flex gap-[10px] items-center shrink-0">
                  <div className="bg-[rgba(105,105,105,0.5)] rounded-[4px] w-[33px] h-[33px] flex items-center justify-center">
                    <Image src="/images/home_paradigm-shift/Time Zone - iconSvg.co.svg" alt="Time" width={30} height={30} className="object-contain" />
                  </div>
          ...
          <div className="flex flex-col w-full flex-1 max-w-[600px] lg:max-w-none">
            ...
            <div className="bg-neutral-800 rounded-[8px] overflow-hidden mb-[16px]">
              ...
              <div className="relative w-full aspect-[400/280] overflow-hidden rounded-b-[8px]">
                <Image src="/images/home_paradigm-shift/infinity-macbook.png" alt="Infinity computer mockup" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" />
              </div>
            </div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 sm:gap-4 lg:gap-2 xl:gap-4">
                ...
                <div className="flex items-center gap-[6px] shrink-0">
                  <div className="w-[36px] h-[36px] bg-[rgba(105,105,105,0.5)] rounded-[4px] flex items-center justify-center shrink-0">
                    <Image src="/images/home_paradigm-shift/Thunder - iconSvg.co.svg" alt="Thunder" width={30} height={30} className="object-contain" />
                  </div>
                ...
                <div className="flex items-center gap-[6px] shrink-0">
                  <div className="w-[37px] h-[37px] bg-[rgba(105,105,105,0.5)] rounded-[4px] flex items-center justify-center shrink-0">
                    <Image src="/images/home_paradigm-shift/Cpu Overheating - iconSvg.co.svg" alt="CPU" width={30} height={30} className="object-contain" />
                  </div>
                  <div className="flex flex-col gap-[2px]">
                ...
                <div className="flex items-center gap-[6px] shrink-0">
                  <div className="w-[38px] h-[38px] flex items-center justify-center shrink-0">
                    <Image src="/images/home_paradigm-shift/Bold Infinity - iconSvg.co.svg" alt="Infinity" width={30} height={30} className="object-contain" />
                  </div>
                  <div className="flex flex-col gap-[2px]">
      ...
      <section className="relative z-10 mt-24 px-4 md:px-8 max-w-[1300px] mx-auto w-full">
        
        {/* MOBILE HEADING: Displays at the very top, hides on Desktop (xl) */}
        <div className="xl:hidden w-full text-center md:text-left mb-8 md:mb-10">
          <h2 className="text-gradient-primary font-bold text-[36px] md:text-[48px] leading-[1.1] md:leading-tight">
            Four things no computer <br className="hidden md:block" /> has done before.
          </h2>
        </div>

        {/* Container is flex-col-reverse on mobile (Image on top of list), flex-row on desktop */}
        <div className="flex flex-col-reverse xl:flex-row gap-12 lg:gap-16 items-center justify-center w-full">
          
          {/* Left Block: Text & Controls */}
          <div className="flex flex-col gap-6 md:gap-8 w-full flex-1 max-w-[550px] xl:max-w-none text-center xl:text-left">
            <div className="flex flex-col gap-[16px]">
              
              {/* DESKTOP HEADING: Hidden on mobile, displays natively inside the left column on Desktop */}
              <h2 className="hidden xl:block text-gradient-primary font-bold text-[48px] leading-tight">
                Four things no computer <br /> has done before.
              </h2>
              
              {/* Clickable List Items */}
              <div className="flex flex-col gap-4 sm:gap-[3px] items-center xl:items-start text-left">
                {fourThings.map((item, i) => (
                  <div
                    key={item.num}
                    onClick={() => setActiveIndex(i)}
                    className={`cursor-pointer transition-all duration-200 text-[16px] md:text-[18px] leading-normal flex gap-4 md:gap-5 ${
                      i === activeIndex
          ...
          {/* Right Block: Perfect-Fit Desktop Mockup Container */}
          <div className="w-full flex-1 max-w-[650px] xl:max-w-none">
            <div className="relative aspect-[14/8] w-full rounded-[12px] overflow-hidden shadow-2xl border border-white/5 bg-neutral-900/40 backdrop-blur-md">
              <Image
                src={fourThings[activeIndex].image}
