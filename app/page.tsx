...
export default function Home() {
  {/* State for section 12 */ }
  const [activeIndex, setActiveIndex] = useState(0);
  {/* State for section 13 */ }
  const [activeCase, setActiveCase] = useState<number | null>(null);
  {/* State for section 14 */ }
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-x-hidden">
      ...
      {/* 1. Hero */}
      <section className="relative z-10 pt-[228px] pb-0 flex flex-col items-center text-center px-1">
        <div className="flex flex-col items-center gap-6 max-w-full mx-auto">
          <h1 className="text-gradient-primary font-bold text-[72px] leading-[1.2] tracking-[-2px] text-center">
            Run Anything
            <br />
            On Everything
          </h1>
          <p className="text-muted text-[18px] leading-7 tracking-[0.1px] text-center max-w-[460px]">
      ...
      <section className="relative z-10 mt-1">
        ...
        >
          {/* Image -- expanded slightly beyond Figma bounds to eliminate internal image padding */}
          <div
          ...
          <div className="absolute pointer-events-none flex items-center justify-center"
            style={{ left: "83.5%", top: "3.5%", width: "0px", height: "53px" }}>
          ...
          {/* Arrow 9 -- "GPU telemetry" */}
          <div className="absolute pointer-events-none flex items-center justify-center"
            style={{ left: "11%", top: "24.41%", width: "51.29px", height: "19.35px" }}>
          ...
          {/* Arrow 8 -- "Two GPUs" */}
          <div className="absolute pointer-events-none flex items-center justify-center"
            style={{ left: "10%", top: "46.55%", width: "68.75px", height: "26.49px" }}>
          ...
          {/* Arrow 4 -- "Agent" */}
          <div className="absolute pointer-events-none flex items-center justify-center"
            style={{ left: "82%", top: "57.09%", width: "106.88px", height: "61.68px" }}>
          ...
          {/* Arrow 5 -- "Hands off" */}
          <div className="absolute pointer-events-none flex items-center justify-center"
            style={{ left: "82%", top: "77.8%", width: "114.74px", height: "75.12px" }}>
          ...
          {/* Arrow 7 -- "Windows+linux" */}
          <div className="absolute pointer-events-none flex items-center justify-center"
            style={{ left: "44.92%", top: "88%", width: "127.06px", height: "84.44px" }}>
        ...
        <div className="xl:hidden max-w-[1100px] mx-auto px-1">
          <div className="relative w-full rounded-[18px] overflow-hidden" style={{ aspectRatio: "837/514" }}>
            <Image
              src="/images/homepage-frame-1.png"
      ...
      <section className="relative z-10 mt-16 px-1 max-w-[760px] mx-auto flex flex-col gap-4">
        <div className="flex items-end gap-0">
          <div className="relative bg-neutral-800 rounded-[18px] rounded-bl-[4px] px-[12px] py-[6px] max-w-[476px]">
            <p className="text-neutral-200 text-[18px] leading-6 tracking-[0.22px] capitalize font-normal">
            ...
            {/* Tail -- bottom--left, pointing left */}
        ...
        <div className="flex justify-end items-end gap-0">
          <div className="relative bg-emerald-500 rounded-[12px] rounded-br-[4px] px-[14px] py-[6px]">
            <p className="text-[rgba(255,255,255,0.9)] text-[18px] leading-[22px] tracking-[-0.4px] text-right whitespace-nowrap">
              We Fixed that
            </p>
            {/* Tail -- bottom--right, pointing right */}
      ...
      <section className="relative z-10 mt-24 px-1 max-w-[1600px] mx-auto">
        <div className="flex items-center gap-[133px]">
          {/* Left text */}
          <div className="flex flex-col gap-[25px] w-[494px] shrink-0">
            <h2 className="text-gradient-primary font-bold text-[56px] leading-[1.2]">
              The OS for the age of AI agents
            </h2>
            <p className="text-white text-[16px] leading-normal font-normal w-[392px]">
          ...
          {/* Right card -- wrapper is relative so annotation can escape overflow--hidden */}
          <div className="relative shrink-0 w-[460px] flex flex-col gap-[10px]">
            ...
            {/* Annotation */}
            <div className="absolute pointer-events-none flex items-center gap-[10px]"
      ...
      <section className="relative z-10 mt-24 px-1 text-center mb-7">
        <h2 className="text-gradient-primary capitalize font-bold text-[70px] leading-[1.05] tracking-[0.22px] whitespace-nowrap">
          This is one session
        </h2>
      </section>

      {/* 6. Session Frame */}
      <section className="relative py-8 px-6 w-full max-w-[1600px] mx-auto z-10">
        <SessionFrame />
      </section>

      {/* 7. Stats Bar */}
      <section className="relative z-10 mt-16 px-1 max-w-[1600px] mx-auto">
        <div className="bg-[rgba(34,34,34,0.6)] rounded-[12px] px-12 py-6">
      ...
      <section className="relative z-10 mt-24 px-1 text-center">
        <div className="flex flex-col items-center gap-0">
          <h2 className="text-gradient-primary font-bold text-[56px] leading-[1.2] inline-block">
            Pick your app.
          </h2>
          <h2 className="text-gradient-primary font-bold text-[56px] leading-[1.2]">
      ...
      {/* 9. 3--step cards */}
      <section className="relative z-10 mt-12 px-1 max-w-[1600px] mx-auto">
        <div className="flex gap-8 items-start justify-center">
          {steps.map((step) => (
            <div key={step.label} className="flex flex-col gap-[19px] flex-1 max-w-[500px]">
              <div className="bg-[rgba(34,34,34,0.6)] rounded-[8px] overflow-hidden">
      ...
      <section className="relative z-10 mt-32 px-1 text-center">
        <h2 className="text-gradient-primary font-bold text-[56px] leading-[1.2] inline-block">
          The paradigm shift
        </h2>
      </section>
      ...
      <section className="relative z-10 mt-[128px] px-1 max-w-[1600px] mx-auto w-full">
        <div className="flex flex-col lg:flex-row lg:gap-[97px] items-center lg:items-start justify-center w-full">
          ...
          <div className="flex flex-col w-full max-w-[681px] shrink-0 mb-16 lg:mb-0">
            <div className="flex flex-col gap-[7px]">
              <div className="flex flex-col gap-[12px]">
                ...
                <h3 className="text-gradient-primary font-bold text-[56px] leading-[1.05] tracking-[-1px]">
                  Every other<br />computer.
                </h3>
              </div>
              <p className="text-neutral-400 text-[14px] font-bold leading-normal max-w-[416px]">
            ...
            {/* FIXED: The Old Way Icon List */}
            <div className="mt-4 bg-neutral-800 rounded-[12px] px-10 py-[17px]">
              <div className="flex flex-col sm:flex-row gap-6 sm:gap-[60px] items-start sm:items-center">
                ...
                {/* Item 2 - FIXED: Uses matching clock icon */}
                <div className="flex gap-[10px] items-center shrink-0">
                  <div className="bg-[rgba(105,105,105,0.5)] rounded-[4px] w-[33px] h-[33px] flex items-center justify-center">
                    <span className="text-white text-[18px]">⏱️</span>
                  </div>
          ...
          <div className="flex flex-col w-full max-w-[672px] shrink-0">
            ...
            <div className="bg-neutral-800 rounded-[12px] w-full p-5 sm:px-8">
      ...
      <section className="relative z-10 mt-24 px-1 max-w-[1600px] mx-auto">
        <div className="flex flex-col xl:flex-row gap-12 xl:gap-[97px] items-center justify-center px-4">
          {/* Left */}
          <div className="flex flex-col gap-10 xl:gap-[110px] w-full max-w-[663px] shrink-0">
            <div className="flex flex-col gap-[16px]">
              <h2 className="text-gradient-primary font-bold text-[36px] sm:text-[48px] leading-tight">
                Four things no OS has <br /> done before.
              </h2>
          <p className="text-muted text-[16px] leading-[1.2] font-normal">
              ...
              <div className="flex flex-col gap-4 sm:gap-[3px] mt-8">
                {fourThings.map((item, i) => (
                  <p
                    key={item.num}
                    onClick={() => setActiveIndex(i)}
                    className={`cursor-pointer transition-all duration-200 text-[16px] leading-normal whitespace-pre-wrap ${i === activeIndex
          ...
          <div className="flex flex-col gap-[12px] shrink-0 w-full max-w-[767px]">
            <div className="relative aspect-[567/415] w-full bg-[rgba(34,34,34,0.6)] rounded-[12px] overflow-hidden">
              ...
              <div className="absolute top-[35px] left-[3px] right-[3px] bottom-[14px] rounded-[8px] overflow-hidden">
                <Image
                  // Dynamically change the image based on the clicked step
                  src={
                    activeIndex === 0 ? "/images/four-things-macbook.png" :
                      activeIndex === 1 ? "/images/Property 1.png" : // Step 2 uses your uploaded image
            ...
            <p className="text-neutral-400 text-[14px] leading-normal w-full max-w-[545px]">
      ...
      <section className="relative z-10 mt-32 px-1 max-w-[1600px] mx-auto flex flex-col items-center">
        <h2 className="text-gradient-primary font-bold text-[48px] sm:text-[56px] leading-[1.2] text-center mb-[80px]">
          What people are<br /> building
        </h2>

        <div className="flex flex-col xl:flex-row gap-[60px] xl:gap-[90px] items-center xl:items-start justify-center w-full">
          ...
          <div className="flex flex-col gap-8 w-full max-w-[480px] shrink-0 mt-15">
              ...
              {useCasesData.map((uc, i) => {
                ...
                return (
                  <div key={uc.title} className="flex flex-col">
                    ...
                    >
                      <p className={`text-[16px] sm:text-[18px] font-bold whitespace-nowrap transition-colors duration-200 ${isOpen ? 'text-white' : 'text-[#ddd] group-hover:text-white'}`}>
                        {uc.title}
                      </p>
                      <svg
                    ...
                    {/* Expandable Body */}
                    <div
                      className={`overflow-hidden transition-all duration-300 ease-in-out ${isOpen ? 'max-h-[150px] opacity-100 mb-4' : 'max-h-0 opacity-0'
                        }`}
                    >
                  <p className="text-muted text-[14px] leading-relaxed pr-8">
                        {uc.description}
                      </p>
                    </div>
            ...
            <div className="mt-2">
              <Button href="/use-cases" size="md">
                Learn More <span className="ml-2 font-normal"></span>
              </Button>
            </div>
          </div>
          ...
          <div className="relative shrink-0 w-full max-w-[751px] aspect-[751/495]">
            ...
            <div className="absolute left-[10px] right-[10px] top-[37px] bottom-[10px] bg-neutral-800 rounded-[8px] overflow-hidden">
              {/* 1:1048 — Ellipse 94 — rotate(-46.96deg), left:126px top:-35px */}
              <div className="absolute pointer-events-none flex items-center justify-center" style={{ left: "126px", top: "-35px", width: "1386px", height: "1387px" }}>
                <div style={{ transform: "rotate(-46.96deg)" }}>
                  <div className="relative" style={{ width: "996px", height: "967px" }}>
                    <div className="absolute" style={{ inset: "-51.71% -50.2%" }}>
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img alt="" className="block max-w-none w-full h-full" src="/images/ellipse-94.png" />
                    </div>
                  </div>
                </div>
              </div>
              {/* 1:1049 — Ellipse 95 — rotate(113.4deg), left:-565.82px top:-552px */}
              <div className="absolute pointer-events-none flex items-center justify-center" style={{ left: "-565.82px", top: "-552px", width: "1125px", height: "1128px" }}>
                <div style={{ transform: "rotate(113.4deg)" }}>
                  <div className="relative" style={{ width: "859px", height: "854px" }}>
                    <div className="absolute" style={{ inset: "-58.54% -58.18%" }}>
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img alt="" className="block max-w-none w-full h-full" src="/images/ellipse-95.png" />
                    </div>
                  </div>
                </div>
              </div>
              <div className="absolute inset-0 rounded-[8px] overflow-hidden">
                <Image
                  // Changes image dynamically based on active case (defaults to index 0 if null)
      ...
      {/* 14. Pricing */}
      <section className="relative z-10 mt-24 px-1 max-w-[1600px] mx-auto">
        <h2 className="text-gradient-primary font-bold text-[56px] leading-[1.2] text-center mb-12">
          Pricing
        </h2>
        <div className="flex flex-col lg:flex-row gap-[23px] items-center justify-center">
      ...
      <section className="relative z-10 mt-24 px-1 max-w-[1600px] mx-auto text-center">
        <div className="flex flex-col gap-[36px] items-center w-[905px] mx-auto">
          <p className="text-neutral-400 text-[20px] font-bold">Already running in production</p>
          <div className="flex gap-[47px] items-center justify-center text-white text-[32px] font-bold">
      ...
      {/* 16. CTA */}
      <section className="relative z-10 mt-24 pb-24 px-1 text-center">
        <div className="flex flex-col gap-[30px] items-center w-[510px] mx-auto">
          <h2 className="text-gradient-primary font-bold text-[64px] leading-[80px]">
            The computer just grew up.
          </h2>
          <p className="text-neutral-500 text-[16px] font-bold">Start building on Infinity.</p>
          <Button href="/how-it-works" size="md">
            Try Infinity
          </Button>
        </div>
